...
1、币币、币币杠杆获取订单信息、获取订单列表、获取所有未成交订单接口，返回数据中增加如下参数：

具体接口：

获取订单信息：`GET /api/spot/v3/orders/<order_id>`

获取订单列表：`GET/api/spot/v3/orders`

获取所有未成交订单： `GET/api/spot/v3/orders_pending`
...
rebate_currency | String | 反佣金币种 USDT  
rebate | String | 反佣金额，平台向达到指定lv交易等级的用户支付的挂单奖励（返佣），如果没有返佣金，该字段为""，为正数，例如：0.5  
...
`2019-03-18T07:49:43.306ZGET/api/margin/v3/orders?instrument_id=BTC-
USDT&state=-2&after=2500723297223680`
...
`2018-09-12T07:54:01.582ZGET/api/margin/v3/orders/23356?instrument_id=BTC-
USDT`

或

`2018-09-12T07:54:01.582ZGET/api/margin/v3/orders/2e3356?instrument_id=BTC-
USDT`
...
`2018-09-12T07:51:51.138ZGET/api/margin/v3/orders_pending?limit=2&instrument_id=BTC-
USDT&after=2500723297223680`
...
---|---|---  
currency | String | 账户余额币种  
underlying | string | 标的指数，如：BTC-USD-SWAP，BTC-USD-SWAP  
equity | String | 账户权益  
total_avail_balance | String | 账户余额  
fixed_balance | String | 逐仓账户余额  
margin | String | 已用保证金  
...
##### 返回示例
    ...
    [
    
        {
            "info": [
                {
                    "instrument_id": "BTC-USD-200529-6000-C",
                    "settlement_price": "",
                    "underlying_fixing": "9,519",
                    "type": "Settled"
                },
                {
                    "instrument_id": "BTC-USD-20200529-6000-C",
                    "settlement_price": "0.3440",
                    "underlying_fixing": "",
                    "type": "Settled"
                }
            ],
            ...
            "reserve": "0.0152",
            "clawback_rate": "0.0",
            "timestamp": "2020-05-28T08:00:21.000Z"
        },
        {
            "info": [
                {
            ...
            "reserve": "0.0152",
            "clawback_rate": "0.0",
            "timestamp": "2020-05-27T08:00:21.000Z"
        }
...
##### 返回示例
    ...
    
    {
        ...
        "data":[
            {
                "end_time":"2020-06-18T07:50:00.000Z",
                "href":"",
                "product_type":"1",
                "start_time":"2020-06-18T07:20:00.000Z",
                "status":"2",
                "timestamp":"2020-06-18T07:50:00.008Z",
                "title":"Spot System Maintenance"
            }
        ]
    }
