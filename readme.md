...
50114 | 401 | 无效的授权  
50115 | 405 | 无效的请求类型  
50116 | 200 | Fast API只能创建一个APIKey  
50117 | 200 | 只有API经纪商才可以通过Fast API功能创建APIKey  
50118 | 200 | APIKey绑定APP需要Broker提供IP白名单  
...
58228 | 200 | 不可交易资产提币要求APIKey必须绑定IP |  
