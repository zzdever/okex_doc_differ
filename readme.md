...
## API学习资源与技术支持
  ...
  * 添加官方API技术支持QQ社群，QQ号：2785606214 备注：API+姓名+账号，与专业量化人员交流。
...
返回的第一条K线数据可能不是完整周期k线，返回值数组顺序分别为是：[ts,o,h,l,c,vol,volCcy,volCcyQuote]  
