...
委托失败，账户 {0} 可用余额不足 | 200 | 51008  
委托失败，账户 {0} 可用保证金不足 | 200 | 51008  
委托失败，账户 {0} 可用余额不足，且未开启自动借币 | 200 | 51008  
委托失败，账户 {0} 可用保证金不足，且未开启自动借币 | 200 | 51008  
委托失败，因为 {0} 剩余的档位限额不足，导致可借不足（需借：{1}， 剩余额度{2}，限额 {3}，已用额度{4}） | 200 | 51008  
...
提币申请ID不存在 | 200 | 58215  
不允许执行该操作 | 200 | 58216  
您当前的提现地址存在风险，暂时不能提现，详情请联系客服 | 200 | 58217  
您保存的提现账户已过期 | 200 | 58218  
提币请求已撤销 | 200 | 58220  
提币地址需要标签 | 200 | 58221  
提币地址不合法 | 200 | 58222  
...
充值地址不存在 | 200 | 58301  
充值地址需要标签 | 200 | 58302  
该链{0}充值已关闭 | 200 | 58303  
创建invoice失败 | 200 | 58304  
您的余额不足 | 200 | 58350  
